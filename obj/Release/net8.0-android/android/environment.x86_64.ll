...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.66_name, ; name: libaot-System.Net.NameResolution.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-System.Net.Ping.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
		i64 978135702899430926, ; hash 0xd93093d4972960e, from name: aot-Delivery Porecatu
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1304026318868526056, ; hash 0x1218d50729eb33e8, from name: Delivery Porecatu
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 33
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-System.IO.Pipes.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-System.Diagnostics.Process.dll.so
		ptr null; void* handle (0x0)
	}, ; 126
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9690042140286182193, ; hash 0x8679f1fc8e52e331, from name: aot-Delivery Porecatu.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 258
	...
	%struct.DSOCacheEntry {
		i64 10793547945828147442, ; hash 0x95ca62ab893be0f2, from name: libaot-Delivery Porecatu.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 15930378505723363406, ; hash 0xdd1412d92328c04e, from name: libaot-Delivery Porecatu
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
	...
	%struct.DSOCacheEntry {
		i64 16575131743849635571, ; hash 0xe606b28091755ef3, from name: Delivery Porecatu.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Delivery Porecatu.dll.so
		ptr null; void* handle (0x0)
	}, ; 464
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a8c03e9d-c7f8-4b2c-b7a1-7bb4a45f8a44\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.deliveryporecatu\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-Delivery Porecatu.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [41 x i8] c"libaot-System.Diagnostics.Process.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
...
@.DSOCacheEntry.66_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 16
@.DSOCacheEntry.67_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Ping.dll.so\00", align 16
